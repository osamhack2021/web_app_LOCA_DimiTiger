  ...
  return (
    <section className={styles.features}>
      <div className="container">
        ...
        <div class="row">
          <div class="col col--6">
            <div className={styles.featuresCardA}><a href="/web_app_LOCA_DimiTiger/docs/intro" className={styles.overlay}>🔗자세히 보기</a>
            </div>
          ...
          <div class="col col--6">
            <div className={styles.featuresCardB}><a href="/web_app_LOCA_DimiTiger/docs/intro" className={styles.overlay}>🔗자세히 보기</a></div>
            <div class="text--center padding-horiz--md">
          ...
          <div class="col col--6">
            <div className={styles.featuresCardC}><a href="/web_app_LOCA_DimiTiger/docs/intro" className={styles.overlay}>🔗자세히 보기</a></div>
            <div class="text--center padding-horiz--md">
              <h3>⚠ 위치 기반 긴급보고 체계</h3>
          ...
          <div class="col col--6">
            <div className={styles.featuresCardD}><a href="/web_app_LOCA_DimiTiger/docs/intro" className={styles.overlay}>🔗자세히 보기</a></div>
            <div class="text--center padding-horiz--md">
